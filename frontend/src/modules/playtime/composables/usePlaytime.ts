...
const playtimeAdd = (playtimes: Ref<Array<Playtime>>, playtimeNew: Ref<Playtime>) => {
  playtimes.value = [...playtimes.value, playtimeNew.value];
  playtimeNew.value = new Playtime();
};

const playtimeRemove = (playtimes: Ref<Array<Playtime>>, playtime: Playtime) => {
...
export const usePlaytime = (playtimes: Ref<Array<Playtime>>) => {
  ...
  return {
    ...
    playtimeRemove: (playtime: Playtime) => playtimeRemove(playtimes, playtime),
  };
};
