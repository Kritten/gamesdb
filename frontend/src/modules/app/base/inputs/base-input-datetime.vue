...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const valueInternal = computed({
            ...
            get: () => {
                const timezoneOffsetInMinutes =
                    props.modelValue.getTimezoneOffset();
                return subMinutes(props.modelValue, timezoneOffsetInMinutes)
                    .toISOString()
                    .substring(0, 16);
            },
        ...
        const valueFormatted = computed(() =>
            format(props.modelValue as unknown as Date, 'PPP p', { locale: de })
        );
