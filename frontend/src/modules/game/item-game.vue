        ...
        <div class="col-12">
            ...
            <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    >
                        <div
                            :class="[infoForGame === null ? 'col-12' : 'col-6']"
                        >
                            <base-input-number
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const complexityFromBGG = (complexity: number) =>
            Math.round(complexity) - 1;
        ...
        return {
            ...
            async loadInfoForGame() {
                ...
                if (props.applyInfoBGGImmediately) {
                    ...
                    ratingBGGInternal.value = ratingFromBGG(
                        response.statistics.ratings.average
                    );
                    complexityInternal.value = complexityFromBGG(
                        response.statistics.ratings.averageweight
                    );
