    ...
    >
        <template #item="propsUpdate">
            <item-game
                ...
                v-model:countPlayersMin="
                    propsUpdate.entity.value.countPlayersMin
                "
                v-model:countPlayersMax="
                    propsUpdate.entity.value.countPlayersMax
                "
                v-model:minutesPlaytimeMin="
                    propsUpdate.entity.value.minutesPlaytimeMin
                "
                v-model:minutesPlaytimeMax="
                    propsUpdate.entity.value.minutesPlaytimeMax
                "
