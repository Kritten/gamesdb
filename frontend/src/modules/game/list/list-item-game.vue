<template>
    <div class="col-12 col-md-6 col-lg-4 col-xl-3">
        <div v-if="game.value === null">test</div>
        <q-card
            v-else
                ...
                <q-markup-table flat>
                    <tbody>
                            ...
                            <td>
                                <display-playtime-game
                                    :minutes-playtime-min="
                                        game.value.minutesPlaytimeMin
                                    "
                                    :minutes-playtime-max="
                                        game.value.minutesPlaytimeMax
                                    "
                                />
                            </td>
                        </tr>
                        <tr>
                            <td>{{ t('game.isCoop') }}</td>
                            <td>
                                <display-is-coop :is-coop="game.value.isCoop" />
                            </td>
                        </tr>
                    </tbody>
                </q-markup-table>
        ...
        return {
            ...
            infoCountPlayers: computed(() => {
                ...
                return t(
                    ...
                    props.game.value.countPlayersMin ===
                        props.game.value.countPlayersMax
                        ? 1
                        : 2
                );
            }),
