<template>
    <template v-if="game !== null">
        <div class="row q-col-gutter-md">
            ...
            <div class="col-12">
                <base-card
                    :title="`${t('session.label', 2)} (${
                        countSessions === undefined ? '' : countSessions
                    })`"
                    expandable
                >
                    <template #actions>
